            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Edit Sub Kriteria</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('categories-subs.update', $categoriesSub->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
